...
export HEROKU_APP_NAME='vb-server-development'
export DATABASE_URL_SSL='?ssl=true'

#Override values in default.js
export VB_base_url=https://vb-server-development.herokuapp.com
