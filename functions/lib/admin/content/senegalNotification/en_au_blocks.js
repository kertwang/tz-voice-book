...
const TwilioBlocks = {
    ...
    'listen_feedback': { type: TwilioTypes_1.BlockType.RECORD, recordingCallback: '/twiml/senegalNotification/recordingCallback/feedback' },
    ...
    'record_0': { type: TwilioTypes_1.BlockType.RECORD, recordingCallback: '/twiml/senegalNotification/recordingCallback/message' },
