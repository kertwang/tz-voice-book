            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, ctx.firebaseApi.getPendingRecordingsWithRetries(botId, ctx.callSid, 1, 8, 100)];
                    case 4:
                        recordings = _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ctx.firebaseApi.getPendingRecordings(ctx.callSid, 1, config.botId)];
                    case 2:
                        pendingRecordings = _b.sent();
                        if (!(pendingRecordings.length === 1)) return [3 /*break*/, 4];
                        return [4 /*yield*/, ctx.firebaseApi.postRecording(pendingRecordings[0], config.botId)];
                    case 3:
                        recordingId = _b.sent();
