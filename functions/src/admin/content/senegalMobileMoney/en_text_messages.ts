...
const en_text: SenegalMobileMoneyMessageMap = {
  ...
  'story_1_intro_option_1': [
    generateText('To hear what the code, which is also called a PIN, is for, press 1 at any time'),
  ],
  'story_1_intro_option_2': [
    generateText('To hear what the agent told me, press 2'),
  ],
  'story_1_pin_advice': [
    generateText('You type your PIN to access your money. Remember, you can call Orange if you forget yours and want a new one but that can take time - it’s better to remember it. Only share your pin with people you share money with.'),
  ],
  'story_1_pin_option_1': [
    generateText('To hear the number for customer care, press 1'),
  ],
  'story_1_pin_option_2': [
  ...
  'story_1_end': [
    generateText("I asked the agent to tell me the customer care number. I called them and said I forgot my PIN. They asked me a few questions to make sure it wasn't someone pretending to me, and then I chose a new PIN that I could easily remember.I went back to the mobile money agent and took out my money."),
  ],
  'story_1_next': [
    generateText("To hear the next story, just stay on the line. Otherwise, you can hang up at any time."),
  ],
  'story_2_intro': [
    generateText("My daughter asked me to give her some money. She lives far away, so I had to use my phone, but before I could send her anything I wanted to see if I had enough money in my account. I couldn’t remember how to do this, so I asked my son."),
  ],
  'story_2_intro_option_1': [
    generateText('To hear what my son told me about how to send money to my daughter, press 2 on your phone.'),
  ],
  'story_2_intro_option_2': [
    generateText('To hear what my son told me about how to send money to my daughter, press 2 on your phone.'),
  ],
  'story_2_explain': [
    generateText('To see see how much money is in your account, you have to press a few numbers on your keypad. I would recommend you write this down. Ready? You type # 144 # 1 * After that you enter your secret mobile money code, which is also called a PIN, and then press # again.'),
  ],
  'story_2_explain_option_1': [
    generateText("To hear what to do if you do not know your PIN, press 1 on your phone keypad at any time"),
  ],
  'story_2_explain_option_2': [
    generateText("To hear how Chidi sent money to his daughter, press 2 on your phone."),
  ],
  'story_2_customer_care': [
    generateText("If you don’t know your pin, call customer care by dialing #1441 and tell them you forgot your PIN. They'll help you."),
  ],
  'story_2_send_no_agent': [
    generateText("I entered the number my son told me and was now sure that I had enough money in my account. Then I had another question: how do I send money to my daughter directly without going to an agent?"),
  ],
  'story_2_send_agent_option_1': [
    generateText('>To hear what Chidi’s son told him for how to send money, press 1'),
  ],
  'story_2_send_explain': [
    generateText('To send money, you start by dialing this number. You might want to write it down. Ready? It is: #155#. Then you can just follow the steps that it tells you.'),
  ],
  'story_2_send_explain_option_1': [
    generateText('To hear the steps for sending money, press 1.'),
  ],
  'story_2_send_explain_option_2': [
    generateText('To hear what I did and whether it worked, press 2'),
  ],
  'story_2_send_explain_2': [
    generateText('The first step is to select the option to transfer money, next you enter the phone number of the person you want to send money to. Then you enter the amount of money you want to send and press 1 to confirm that it’s the right amount. Finally you enter your secret code, which is also called your PIN.'),
  ],
  'story_2_end': [
    generateText('I dialed #155# like my son told me and then followed the steps that were given to me on my phone. After I was done my daughter called me to say thanks. She had received a notification on her phone that the money had arrived.'),
  ],
  'story_2_next': [
    generateText('To hear the next story, just stay on the line. Otherwise, you can hang up at any time.'),
  ],
