...
const TwilioBlocks: BlockMap = {
  ...
  'listen_feedback': { type: BlockType.RECORD, recordingCallback: '/twiml/voicebook/recordingCallback/feedback' },
  'listen_feedback_complete': { type: BlockType.DEFAULT },
  'error_0': { type: BlockType.DEFAULT },
  'info_0': { type: BlockType.DEFAULT },
  'record_0': { type: BlockType.RECORD, recordingCallback: '/twiml/voicebook/recordingCallback/message' },
