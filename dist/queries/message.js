...
function getAllMessages() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, db_1["default"](tableName)
                    .select('*')];
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, db_1["default"](tableName)
                    .insert(message)
                    .returning('*')
                    .then(function (r) { return AppProviderTypes_1.makeSuccess(utils_1.as(r)); })["catch"](function (err) { return AppProviderTypes_1.makeError(err); })];
        });
    });
}
/* FOR TESTING ONLY */
function _truncate() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, db_1["default"].raw('TRUNCATE TABLE message CASCADE')];
        });
    });
}
exports["default"] = {
