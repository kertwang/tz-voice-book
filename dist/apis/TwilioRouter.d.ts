...
export default class TwilioRouter {
    static nextMessage(ctx: CallContext, config: BotConfig, currentBlock: BlockId | string): Promise<string>;
    /**
     * Given a blockId, find the Flow, Block and Messages, and build a
     * twilio response
     */
    static getBlock(ctx: CallContext, config: BotConfig, blockName: BlockId | string): Promise<any>;
     ...
     */
    static gatherNextMessage(ctx: CallContext, config: BotConfig, currentBlock: BlockId | string, gatherResult: DigitResult): Promise<string>;
}
