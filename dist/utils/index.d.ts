...
export declare function getBotId(maybeBotId: string): BotId | string;
export declare function getDefaultVersionForBot(botId: BotId): VersionId;
export declare function pathToBlock(path: string): BlockId | string;
...
export declare const unique: (array: any[]) => string[];
/**
 ...
 * @param
 */
export declare const getFieldsIfExist: (input: {
    [index: string]: any;
}, fields: string[]) => any;
export declare function exists<T>(thing: T | undefined): T;
export declare function as<I, T>(genericBlockId: I): T;
