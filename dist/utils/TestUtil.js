...
var index_1 = __importDefault(require("../admin/content/senegalMobileMoney/index"));
...
var TestUtil = /** @class */ (function () {
    ...
    TestUtil.createDemoContent = function () {
     ...
     */
    TestUtil._truncateAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, flow_1["default"]._truncate()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, message_1["default"]._truncate()];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, user_1["default"]._truncate()];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
