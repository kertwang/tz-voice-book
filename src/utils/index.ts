...
export function getBotId(maybeBotId: string): BotId | string {
...
export function pathToBlock(path: string): BlockId | string {
 ...
 * @param
 */
export const getFieldsIfExist = (input: { [index: string]: any }, fields: Array<string>): any => {
  const finalObj: any = {};
...
export function exists<T>(thing: T | undefined): T {
  if (!thing) {
...
export function as<I, T>(genericBlockId: I): T {
  // @ts-ignore
